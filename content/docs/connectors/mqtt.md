...
menu: MQTT 
description: "Reference for configuring MQTT data connectors in InfinyOn Cloud"
---

| Data Direction | [Inbound](#inbound-connector) | Outbound |
|:--------------:|:-----------------------------:|:-------------------------------:|
|                | [✅](#inbound-connector)                             | ❌        |
...
Guide for [MQTT to SQL Pipeline]({{<ref "/docs/guides/mqtt-to-sql.md">}}).
...
```
### Transformations
Fluvio MQTT Source Connector supports [Transformations]({{<ref "/docs/resources/transformation-chaining.md">}}). Records can be modified before sending to Fluvio topic.
