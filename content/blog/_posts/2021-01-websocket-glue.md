...
* [Step 1: Add backend server]({{<ref "#step-1-add-backend-server" >}})
* [Step 2: Add frontend client]({{<ref "#step-2-add-frontend-client" >}})
* [Step 3: Add websocket communication]({{<ref "#step-3-add-websocket-communication" >}})
* [Step 4: Add session support]({{<ref "#step-4-add-session-support" >}})
...
<img src="/blog/images/websocket-glue/architecture.svg"
     ...
     style="margin: auto; max-width: 440px" />
...
Install `tsc-watch` and typescript definitions:
...
* [Install ws package]({{<ref "#install-ws-package" >}})
* [Add incoming proxy]({{<ref "#add-incoming-proxy" >}})
* [Attach proxy to server]({{<ref "#attach-proxy-to-server" >}})
...
* [Add websocket script file]({{<ref "#add-websocket-script-file" >}})
* [Load script to html file]({{<ref "#load-script-to-html-file" >}})
* [Add scripts route to server]({{<ref "#add-scripts-route-to-serve" >}})
...
```bash
$ mkdir public/scripts && touch public/scripts/ws-script.js
```
...
* [Add session cookies for client requests]({{<ref "#add-session-cookies-for-client-requests" >}})
* [Add session management for server requests]({{<ref "#add-session-management-for-server-requests" >}})
...
<img src="/blog/images/websocket-glue/webcookies.svg"
     alt="WebSocket Frontend"
     style="margin: auto; max-width: 580px" />
...
* [Build your own custom Bot Assistant]({{<ref "2021-02-bot-assistant" >}})
* [Build a persistent Chat App without a database]({{<ref "2021-01-persistent-chat-app" >}})
