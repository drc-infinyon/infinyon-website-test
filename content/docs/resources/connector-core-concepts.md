...
menu: Connector Core Concepts
weight: 80
---

There are 4 steps to the connector:

<img src="/docs/images/connectors/smart-connectors-extra.svg"
...
Start a connector on [InfinyOn Cloud](https://infinyon.cloud), and let us manage the infrastructure